...
""", unsafe_allow_html=True)
     ...
     with province:
          province = st.selectbox("**Province**", options=province_values, index=None, placeholder="Ex. Brussels")
     with locality:
          if province != None:
               locality = st.selectbox("**Locality**", options=belgium_localities[province], index=None, placeholder="Choose a locality")
          else:
     ...
     with equipped_kitchen:
          equipped_kitchen = st.selectbox("**Kitchen Type**", options=mapping_simplified.keys(), index=None, placeholder="Select Kitchen Type...")
